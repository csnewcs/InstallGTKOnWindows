...
namespace InstallGTKOnWindows
{
    class Program
    {
        // msys2링크: https://repo.msys2.org/distrib/x86_64/msys2-x86_64-20210215.exe
        // 
        static void Main(string[] args)
        {
            ...
            client.DownloadFileAsync(new Uri("https://repo.msys2.org/distrib/x86_64/msys2-x86_64-20210215.exe"), "msys2install.exe");
            while (doing)
            {
                sec = false;
                Thread.Sleep(500);
